#include "ImPushButtonPlugin.h"
#include "ImPushButton.h"
ImPushButtonPlugin::ImPushButtonPlugin(QObject* parent){}
bool ImPushButtonPlugin::isContainer() const{return false;}
bool ImPushButtonPlugin::isInitialized() const{
    return initialized;
}
QIcon ImPushButtonPlugin::icon() const{
...
QString ImPushButtonPlugin::domXml() const{
    return QLatin1String(R"(
<ui language="c++">
  <widget class="ImPushButton" name="imPushButton">
...
QString ImPushButtonPlugin::group() const{
    return QStringLiteral("QImgui Widgets");
}
QString ImPushButtonPlugin::includeFile()const{
     return QStringLiteral("ImPushButton.h");
}
QString ImPushButtonPlugin::name()const{
    return QStringLiteral("ImPushButton");
}
QString ImPushButtonPlugin::toolTip() const{return QString("");}
QString ImPushButtonPlugin::whatsThis() const{return QString("");}
QWidget* ImPushButtonPlugin::createWidget(QWidget* parent) {
    auto* w = new ImPushButton(parent);
    return w;
}
void ImPushButtonPlugin::initialize(QDesignerFormEditorInterface* core) {
